...
def run_all_jobs(ch_client) -> dict:
    ...
    # 12. Strategy P&L (measure paper-trading performance per strategy)
    # Runs after NAV so it sees the freshest fills and resolutions
    results['strategy_pnl'] = run_strategy_pnl_job(ch_client)

    # 13. Notification Dispatch (send alerts to Discord/Telegram/Webhooks)
